...
from backend import gemini_service, email_service, lesson_manager, config as config_loader
...
def render_dashboard():
    ...
    contacts_list = db.admin_get_all_students()
    ...
    with tab5:
        ...
        results = db.admin_get_quiz_results()
